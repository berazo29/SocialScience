...
class data_analysis:
    ...
    def question0(self):
        ...
        data_to_sort0 = zip(gdppc_raw, oil_consumption_per_capita_norm, electricity_consumption_per_capita_norm,
                            gas_consumption_per_capita_norm, energy_consumption_average, energy_consumption_std)
        sorted_data0 = sorted(data_to_sort0, key=itemgetter(0))
        gdppc_raw_sorted, oil_consumption_per_capita_norm_sorted, electricity_consumption_per_capita_norm_sorted, gas_consumption_per_capita_norm_sorted, energy_consumption_ave_sorted, energy_consumption_std_sorted = zip(
            *sorted_data0)
        ...
        ax1_1.plot(list(gdppc_raw_sorted), list(electricity_consumption_per_capita_norm_sorted), c='r',
                   label='Electricity')
        ...
        ax1_2.errorbar(list(gdppc_raw_sorted), energy_consumption_ave_sorted, energy_consumption_std_sorted, c='k',
                       capsize=5)
    ...
    def question2(self):
        ...
        print('Average GDP - per capita: ' + str(low_net_birthrate_gdppc_average) + ' +/- ' + str(
            low_net_birthrate_gdppc_std))
    ...
    def question3(self, energy_consumption_average_IN, ratio_kids_survive_over_kids_fatality_IN):
        ...
        A2 = np.vstack([np.asarray(ratio_kids_survive_over_kids_fatality_IN),
                        np.ones(len(ratio_kids_survive_over_kids_fatality_IN))]).T
...
if __name__ == '__main__':
    ...
    ca.question2()
    ca.question3(energy_consumption_average_IN=energy_data_series,
                 ratio_kids_survive_over_kids_fatality_IN=survival_rate_data_series)
# plt.show()
